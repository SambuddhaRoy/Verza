...
import com.lstn.playback.PlaybackViewModel
import com.lstn.ui.components.LocalTrackActions
import com.lstn.ui.components.LstnBottomBar
import com.lstn.ui.components.MiniPlayer
import com.lstn.ui.components.TrackActions
import com.lstn.ui.screens.*

@Composable
fun LstnNavigation(modifier: Modifier = Modifier) {
    ...
    var pendingAdd by remember { mutableStateOf<com.lstn.innertube.models.MusicItem?>(null) }
            ...
            Column {
                ...
                LstnBottomBar(
                    ...
                    onNavigate = { screen ->
                        ...
                        if (currentRoute == screen.route) return@LstnBottomBar
