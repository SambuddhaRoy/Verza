...
object InnerTube {
    ...
    suspend fun searchItems(
        query: String,
        filter: SearchFilter,
    ): List<com.lstn.innertube.models.HomeItem> =
    ...
    suspend fun homeSections(): List<com.lstn.innertube.models.HomeSection> =
     ...
     */
    suspend fun homeFeed(): List<com.lstn.innertube.models.HomeSection> = coroutineScope {
    ...
    suspend fun libraryPlaylists(): List<com.lstn.innertube.models.HomeItem> =
    ...
    suspend fun subscribedArtists(): List<com.lstn.innertube.models.HomeItem> =
    ...
    suspend fun collectionDetail(collectionId: String): com.lstn.innertube.models.CollectionDetail =
        parseCollectionDetail(browse(collectionId))

    /** Fetches an artist page (header + shelves) for a channel [browseId] (UC…). */
    suspend fun artistPage(browseId: String): com.lstn.innertube.models.ArtistDetail =
